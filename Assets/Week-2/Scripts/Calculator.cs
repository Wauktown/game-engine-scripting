...
public class Calculator : MonoBehaviour
{
    ...
    public void AddInput(string input)
    {
        ...
        if (clearPrevInput)
        {
            label.text = string.Empty; // clear the text label
    ...
    public void SetEquationAsAdd()
    {
        ...
        // store the current input into the float
    ...
    {
        float currentInput = float.Parse(label.text);
        float difference = prevInput - currentInput;
    ...
    {
        float currentInput = float.Parse(label.text);
        float product = prevInput * currentInput;
    ...
    public void Divide()
    {
        ...
        if (currentInput != 0)
        {
            // Calculate the quotient of the previous input value divided by the current input value
            float quotient = prevInput / currentInput;

            // Set the text label to display the quotient
    ...
    public void Calculate()
    {
        ...
        // We check the equationtype and call the method being used.
